...
function rowType(rowType, options) {
  var defaultOptions = {
  ...
  var elements = document.querySelectorAll('[data-row-type=' + rowType + ']');

  elements.forEach(function(elem) {

    var rowClass = elem.getAttribute('data-row-type') + '-row ' + getOption('extra_classes') + ' bb-row-wrapper-wrapper ';
    ...
    if (!getOption('keep_ao_row_wrapper_class')) {
      elem.className = '';
    }
    if (getOption('add_bb_classes')) {
      elem.className += ' bb-row-wrapper';
    }
    if (!getOption('keep_ao_row_wrapper_styles')) {
      elem.style = '';
    }
